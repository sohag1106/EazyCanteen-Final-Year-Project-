            ...
            <div class="top-links">
                <div class="container">
                    <ul class="row links">
                        ...
                        <li class="col-xs-12 col-sm-4 link-item active"><span>2</span><a href="dishes.php?c_id=<?php echo $_GET['c_id']; ?>"></a>Order and Pay</li>
                        <li class="col-xs-12 col-sm-4 link-item"><span>3</span><a href="#">Pick Your favorite food</a></li>
                        
                    </ul>
                </div>
            </div>
			<?php $ress= mysqli_query($db,"select * from res_category where c_id='$_GET[c_id]'");
...
?>								  
                                ...
                                <div class="widget-body">
                                    <div class="price-wrap text-xs-center">
                                        ...
                                        <a href="checkout.php?c_id=<?php echo $_GET['c_id'];?>&action=check"  class="btn btn-danger btn-lg disabled">Checkout</a>

                                        <?php
                                        }
                                        else{   
                                        ?>
                                        <a href="checkout.php?c_id=<?php echo $_GET['c_id'];?>&action=check"  class="btn btn-success btn-lg active">Checkout</a>
                                        <?php   
                                        }
                                        ?>
